...
## [0.1.2](https://github.com/databasedav/haalka/compare/haalka-v0.1.1...haalka-v0.1.2) - 2024-10-12

### Other

- bevy 0.14 upgrade, among other things, see changelog
- update readme for bevy 0.14 working branch
- calculator example tweaks + temp fix for challenge02 reactive cursors
- minor doc fixes
All notable changes to this project will be documented in this file.
